namespace Harjoitus_08_Roomalaiset_numerot
{
	public partial class Form1 : Form
	{
		...
		{
			int lukul, luku2, luku3, luku4;
			string vastaus = "";
			if (TekstiTB.Text.Length > 3) // Kyseessa on tuhatluku
			{
				lukul = Convert.ToInt32(TekstiTB.Text.Substring(0, 1)); // Tuhannet
			...
			else if (TekstiTB.Text.Length > 2) // Kyseesssä on sataluku
			{
			...
			else if (TekstiTB.Text.Length > 1) // Kyseessi on kymmenluku
			{
